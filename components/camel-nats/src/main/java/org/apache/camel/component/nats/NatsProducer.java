...
public class NatsProducer extends DefaultAsyncProducer {
    ...
    public boolean process(Exchange exchange, AsyncCallback callback) {
        ...
        if (exchange.getPattern().isOutCapable()) {
            ...
            final CompletableFuture timeoutFuture = this.failAfter(exchange, Duration.ofMillis(config.getRequestTimeout()));
    ...
    protected void doStart() throws Exception {
        ...
        this.connection = this.getEndpoint().getConfiguration().getConnection() != null
                ? this.getEndpoint().getConfiguration().getConnection() : this.getEndpoint().getConnection();
    }
